...
$pdo = conectarDB();
$stmt = $pdo->prepare("SELECT * FROM produtos WHERE categoria = 'Outros' ORDER BY nome");
$stmt->execute();
...
<head>
    ...
    <title>Outras Flores - Floricultura</title>
...
<body>
    ...
    <div class="container-principal">
        <h1 class="titulo-pagina">Outras Flores Populares</h1>
        ...
        <?php if (empty($produtos)): ?>
            <div class="sem-produtos">
                <h2>Nenhuma flor cadastrada</h2>
                <p>Ainda não há flores disponíveis nesta categoria.</p>
            </div>
        <?php else: ?>
                ...
                <?php foreach ($produtos as $produto): ?>
                    <div class="card-produto">
                        ...
                        <div class="card-produto-info">
                            ...
                            <a href="carrinho_action.php?acao=adicionar&id=<?php echo $produto['id']; ?>&retorno=outrasflores.php" 
