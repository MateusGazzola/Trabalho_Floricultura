...
$pdo = conectarDB();
$stmt = $pdo->prepare("SELECT * FROM produtos WHERE categoria = 'Orquideas' ORDER BY nome");
$stmt->execute();
...
<head>
    ...
    <title>Orquídeas - Floricultura</title>
...
<body>
    ...
    <div class="container-principal">
        <h1 class="titulo-pagina">Orquídeas</h1>
        ...
        <?php if (empty($produtos)): ?>
            <div class="sem-produtos">
                <h2>Nenhuma orquídea cadastrada</h2>
                <p>Ainda não há orquídeas disponíveis.</p>
            </div>
        <?php else: ?>
                ...
                <?php foreach ($produtos as $produto): ?>
                    <div class="card-produto">
                        ...
                        $imagemSrc = $produto['imagem'] && file_exists($produto['imagem']) 
                            ...
                            : 'imagens/orquidea1.jpg';
                        ?>
                        <img src="<?php echo $imagemSrc; ?>" 
                             alt="<?php echo htmlspecialchars($produto['nome']); ?>" 
                             onerror="this.src='imagens/orquidea1.jpg'" />
                        <div class="card-produto-info">
                            ...
                            <a href="carrinho_action.php?acao=adicionar&id=<?php echo $produto['id']; ?>&retorno=orquideas.php" 
